    ...
    return (
        <>
            ...
            <div className="flex h-[1080px] flex-col lg:h-auto md:h-auto">
                <Header1 />
                <div className="mt-[126px] flex h-[836px] flex-col items-center 1l:h-auto md:h-auto">
                    <Img src="images/img_vector_img.svg" alt="logo" className="ml-[15%] h-[94px] cursor-pointer" />
                    <div className="container-xs mt-10 flex h-[75px] w-[52%] items-center justify-center rounded-bl-[24px] rounded-br-[24px] rounded-tl-[52px] rounded-tr-[52px] p-3 lg:h-auto 1g:px-5 md:h-auto md: px-5">
                        <div className="flex h-[38px] items-center gap-[22px] lg:h-auto md:h-auto md: flex-col">
                            <div className="flex h-[36px] flex-col items-center gap-1 lg:h-auto md:h-auto">
                                {/* isso aqui era p ser um input do filtro de busca */}
                                <Heading
                                    size="textxl"
                                    as="h1"
                                    className="h-[30px] w-[400px] cursor-text text-[26px] font-light Itext-colors2 lg:text-[22px]"
                                >
                    ...
                    <div className="mt-2.5 flex h-[452px] flex-col items-end gap-5 rounded-[34px] lg:h-auto md:h-auto">
                        <div className="flex h-[56px] items-center gap-4 rounded-tl-[28px] rounded-tr-[28px] p-2.5 lg:h-auto md:h-auto md:flex-col">
                            ...
                            <Heading
                                size="textmd"
                                as="h4"
                                className="block h-[26px] text-[22px] font-medium Itext-colors1 lg:text-[18px]"
                            >
                                COMPETÊNCIA
                            </Heading>
                            <div className="h-[36px] w-[2x] md:h-[2px] md:w-[36px]" />
                            ...
                            <div className="h-[36px] w-[2px] md:h-[2px] md:w-[36px]" />
                            <Heading size="textmd" as="p" className="h-[26px] text-[22px] font-medium I text-colors1 Ig: text-[18px]">
                                VALOR
                            </Heading>
                        </div>
                    ...
                    <div className="mt-3 flex h-[54px] items-center gap-3.5 lg:h-auto md:h-auto">
                        <div className="flex h-[54px] items-center rounded-[26px] p-4 1g:h-auto md:h-auto">
